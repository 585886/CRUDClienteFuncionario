...
<?php foreach ($customers as $customer) : ?>
	<tr style = "color:white; background-color:#7f8c8d;">
		...
		<td class="actions text-right" style = "color:white;">
...
<?php else : ?>
	<tr>
		<td style = "color:white; background-color:#7f8c8d;"colspan="6">Nenhum registro encontrado.</td>
	</tr>
<?php endif; ?>
</tbody>
</table>
